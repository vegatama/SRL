        ...
        <div class="py-5">
            <div class="container m-3 mt-5">
                <div class="col me-5 pe-5 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-lg-8">
                        <div class="card mb-4">
                            <form action="{{route('update_account_admin') }}" method="post" class="signin_form" enctype="multipart/form-data">
                                <div class="card-body">
                                @auth
                                @method("put")
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="mb-3">
                                                <input class="form-control rounded-pill" type="file" name="image" id="image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
