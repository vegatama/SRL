...
<body classname='snippet-body' class="body-pd">
    ...
    <body id="body-pd">
            ...
            <nav class="nav pt-2">
                <div class="pt-5">
                    <div class="nav_list">
                        ...
                        <a href="/edit_text/{{$course->id_course}}" class="nav_sub_link bg-primary">
        ...
        <div class="py-3">
                ...
                <div class="row w-75">
                    ...
                    <div class="card border-secondary">
                        <div class="card-body px-5">
                            <div class="row ">
                                <form method="post" enctype="multipart/form-data" action="{{route('store_file')}}">
                                    @csrf
                                    <!-- id -->
                                    <input class="form-control" type="hidden" name="id_course" id="id_course" value="{{ $course->id_course}}">
                                    <!-- text upload -->
                                    <h3 style="font-weight: 500">Upload Text</h3>
                                    <div class="col py-3">
            ...
            <iframe width="1020" height="700" src="{{asset($course->file)}}">
            </iframe>
        </div>
