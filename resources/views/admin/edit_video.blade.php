...
<body classname='snippet-body' class="body-pd">
    ...
    <body id="body-pd">
            ...
            <nav class="nav pt-2">
                <div class="pt-5">
                    <div class="nav_list">
                        ...
                        <a href="/edit_video/{{$course->id_course}}" class="nav_sub_link bg-primary">
        ...
        <div class="py-3">
                        ...
                        <div class="card-body px-5">
                            <div class="row ">
                                <form method="post" action="{{route('update_video')}}">
                                    ...
                                    <h3 style="font-weight: 500">Video Link</h3>
                                    <div class="col py-3">
                                        <input type="text" class="form-control" name="video" id="video" value="{{$course->video}}" required>
                                    </div>
                                    <div class="col py-3">
            ...
            <iframe width="420" height="315" src="{{$course->video}}"></iframe>
        </div>
