    ...
    <body id="body-pd">
            ...
            <nav class="nav pt-2">
                <div class="pt-5">
                    <div class="nav_list">
                        ...
                        <a href="/edit_audio/{{$course->id_course}}" class="nav_sub_link bg-primary">
        ...
        <div class="py-3">
                ...
                <div class="row w-75">
                    <div class="card border-secondary">
                        <div class="card-body px-5">
                            <div class="row ">
                                <form method="post" action="{{route('update_audio')}}">
                                    @csrf
                                    <!-- id -->
                                    <input class="form-control" type="hidden" name="id_course" id="id_course" value="{{ $course->id_course}}">
                                    <!--Audio link-->
                                    <h3 class="pt-3" style="font-weight: 500">Audio Link</h3>
                                    <div class="col py-3">
                                        <input type="text" class="form-control" name="audio" value="{{$course->audio}}" required>
                                    </div>
                                    <div class="col py-3">
            ...
            <div class="container mx-auto py-3">
                <audio id="audio" src="{{$course->audio}}" type="audio/mpeg" controls></audio>
            </div>
        </div>
