            ...
            <nav class="nav pt-2">
                <div class="pt-5">
                    <div class="nav_list">
                        ...
                        <a href="/coursetest/{{$course->id_course}}" class="nav_sub_link bg-primary">
                        ...
                        <a href="/results/{{$course->id_course}}" class="nav_sub_link bg-secondary">
        ...
        <div class="py-3">
            <div class="container d-flex justify-content-center card-container">
                <div class="card border-primary">
                    <div class="card-body">
                        <h4 class="card-title px-4 d-flex justify-content-center">{{$course->title}} test</h4>
                        <p class="card-text text-center">Time: 00:15:00</p>
                        <p class="card-text text-center">Questions: 10</p>
                        <p class="card-text text-center">Passing Score: 7/10</p>
                        <div class="d-flex justify-content-center">
                            <a href="/test/{{$course->id_course}}" class="btn btn-secondary" style="width:150px">Start</a>
                        </div>
