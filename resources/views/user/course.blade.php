            ...
            <nav class="nav pt-2">
                <div class="pt-5">
                    ...
                    <div class="nav_list">
                        ...
                        <a href="/course" class="nav_link bg-primary">
                        ...
                        <?php foreach ($courses as $course) : ?>
                            <?php if ($course->subject == $elements->subject) : ?>
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <a href="/coursedetail/{{$course->id_course}}" class="card text-left">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="progress ">
                                                <div class="progress-bar" role="progressbar" style="width: 0%; background: #45D05C; border-radius: 20px" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
