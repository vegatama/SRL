            ...
            <nav class="nav pt-2">
                <div class="pt-5">
                    ...
                    <div class="nav_list">
                        ...
                        <a href="/coursecontent/{{$course->id_course}}" class="nav_sub_link bg-primary">
        ...
        <div class="py-3">
            <div class="container m-3 mt-5">
                <div class="row ">
                    ...
                    <iframe width="420" height="315" src="{{$course->video}}">
                    </iframe>
                    <div class="container mx-auto py-3">
                        <audio id="audio" src="{{$course->audio}}" controls></audio>
                    </div>
                    <hr style="height:2px;border-width:5;color:black;background-color:black; width: 100%">
                    <iframe width="420" height="700" src="{{asset($course->file)}}">
                    </iframe>
                </div>
                <hr style="height:2px;border-width:5;color:black;background-color:black; width: 100%">
            </div>
