    ...
    <body id="body-pd">
        ...
        <header class="header body-pd bg-primary" id="header">
            <div class="header_toggle ">
                <img src="{{asset('image/navmenu.png')}}" width="30px" class="ms-n1" alt="nav">
        ...
        <div class="l-navbar show" id="nav-bar">
            <nav class="nav pt-2">
                <div class="pt-5">
                    <div class="nav_list">
                        @if ($level == 1)
                        <a href="/home-admin" class="nav_link bg-secondary">
                            <h6 class="nav_name py-2">Make Course</h6>
                        </a>
                        @else
                        <a href="/course" class="nav_link bg-secondary">
                            <h6 class="nav_name py-2">Course</h6>
                        </a>
                        @endif
                        <a href="/leaderboard" class="nav_sub_link bg-primary">
        ...
        <div class="py-3">
            <div class="px-3">
                <h3 style="font-weight: 500">Leaderboard Class {{ $users[0]->class }}</h3>
